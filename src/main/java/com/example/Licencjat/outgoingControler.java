...
public class outgoingControler {
    ...
    @GetMapping("/outgoingModels")
    ResponseEntity<?>readAllTaskAndSortByAmount(){
        return ResponseEntity.ok(outgoingsRepository.findAll(Sort.by(Sort.Direction.ASC, "amount")));
    }
